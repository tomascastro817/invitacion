  ...
  return (
    <div className="relative w-full h-screen bg-cover bg-center flex items-center justify-center text-center bg-gray-900" style={{ backgroundImage: `url(${fondo})` }}>
      ...
      <div className="relative z-10 w-full sm:w-3/4 md:w-2/3 lg:w-1/2 bg-gray-800/40 p-8 rounded-lg shadow-xl">
        ...
        <h2 className="text-3xl md:text-5xl font-extrabold text-yellow-400 drop-shadow-2xl mb-4 font-[Poppins]">
        ...
        <div className="flex flex-col sm:flex-row gap-4 items-center justify-center">
          ...
          <button
            ...
            className="bg-green-500 hover:bg-green-600 text-white py-3 px-6 rounded-full text-lg flex items-center gap-3 transition-all duration-300 transform hover:scale-110 hover:shadow-lg font-[Poppins]"
          >
